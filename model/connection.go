...
type SendCoManagerRequestPayload struct {
	ProfileID int    `json:"profileID"`
	Id        string `json:"_id"`
	Email     string `json:"email1"`
}

type SendConnectionRequestPayload struct {
	Id    string `json:"_id"`
	Email string `json:"email1"`
}

type AcceptCoManagerRequestPayload struct {
	Code string `json:"code"`
}

type AcceptConnectionRequestPayload struct {
	Code string `json:"code"`
}
